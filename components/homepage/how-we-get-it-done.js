        ...
        <section className="w-full py-32"  data-aos="fade-up">
            <div className="container">
                <div className="flex flex-col justify-center items-center text-unicodez-dark">
                    ...
                    <p className="mt-4 text-unicodez-text text-xl font-medium text-center max-w-sm leading-10">We explore some of the latest trends and strategies</p>
                </div>
                <div className="w-full mt-16">
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-base text-unicodez-text leading-[30px] max-w-sm mt-5">We dot our I&apos;s and cross our T&apos;s. Our quality and standard are uncompromisable.</p>
                        </div>
